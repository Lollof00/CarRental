    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Contattaci</h1>
            <span>sentiti libero di inviarci un messaggio!</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Telefono</h4>
              <p>numero di telefono per contattarci</p>
          ...
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Email</h4>
              <p>inviaci un email, risponderemo a tutte le tue domande</p>
              <a href="mailto:carrentalsapienza@gmail.com"><i class="fa fa-envelope"></i>carrentalsapienza@gmail.com</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="contact-item">
              ...
              <h4>Dove siamo</h4>
              <p>Piazzale Aldo Moro, 5, 00185 Roma RM<br> USA</p>
              <a href="https://goo.gl/maps/kiWikvBPx6Ui6Jnb7">Vedi su Google Maps</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="contact-form">
              <form id="contact" action="${pageContext.request.contextPath}/contactUs" method="get">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="email" type="email" class="form-control" id="email"  placeholder="Indirizzo e-mail" required>
                    </fieldset>
                  </div>
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="filled-button">Manda il messaggio</button>
                    </fieldset>
                  </div>
                </div>
              </form>
